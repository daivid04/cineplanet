<?php
/**
 * API REST para Formato
 * 
 * Endpoints:
 * GET    /api/formato_api.php          - Listar todos los formatos
 * GET    /api/formato_api.php?id=1     - Obtener formato por ID
 * POST   /api/formato_api.php          - Crear nuevo formato
 * PUT    /api/formato_api.php          - Actualizar formato
 * PATCH  /api/formato_api.php          - Cambiar estado (toggle)
 * DELETE /api/formato_api.php?id=1     - Eliminar formato (soft delete)
 */
...
require_once __DIR__ . '/../../src/controllers/FormatoController.php';

$controller = new FormatoController($conn);
    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            if (!$data || !isset($data['nombre']) || trim($data['nombre']) === '') {
                $response = ['success' => false, 'message' => 'El nombre del formato es requerido'];
            } else {
