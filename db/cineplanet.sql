...
CREATE TABLE compra_cliente(
    ...
    id_combo INT,
    id_producto_sede INT NOT NULL,
    id_compra_productos INT NOT NULL,
    FOREIGN KEY (id_combo) REFERENCES combos(id_combo) 
    ON UPDATE CASCADE 
    ON DELETE RESTRICT,
    FOREIGN KEY (id_producto_sede) REFERENCES producto_sede(id_producto_sede) 
    ON UPDATE CASCADE 
    ON DELETE RESTRICT,
    FOREIGN KEY (id_compra_productos) REFERENCES compra_productos(id_precio_productos) 
    ON UPDATE CASCADE 
    ON DELETE RESTRICT
);
...
CREATE TABLE dia_laborable(
	id_dia_laborable INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE horarios_de_trabajo(
	id_h_trabajo INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE horario_trabajador(
    ...
    id_h_trabajo INT NOT NULL,
    id_dia_laborable INT NOT NULL,
    FOREIGN KEY (id_h_trabajo) REFERENCES horarios_de_trabajo(id_h_trabajo)
    ON UPDATE CASCADE
    ON DELETE RESTRICT,
    
    FOREIGN KEY (id_dia_laborable) REFERENCES dia_laborable(id_dia_laborable)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
);