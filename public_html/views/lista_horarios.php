            ...
            <main class="w-full flex-grow p-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="asignar_turno.php" class="inline-flex items-center justify-center rounded-lg bg-cineplanet-blue px-4 py-2.5 text-sm font-medium text-white shadow-soft hover:bg-cineplanet-hover focus:outline-none focus:ring-2 focus:ring-cineplanet-blue focus:ring-offset-2 transition-colors">
