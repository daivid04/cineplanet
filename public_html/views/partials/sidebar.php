<aside class="flex h-full w-60 flex-col bg-cineplanet-dark text-white shadow-lg">
    ...
    <nav class="flex-1 px-4 py-4">
        ...
        <a href="horarios_tester.php" class="mt-2 flex items-center rounded-lg px-4 py-2 <?php echo (isset($activePage) && $activePage === 'horarios') ? 'bg-cineplanet-blue/30 text-white' : 'text-gray-300 hover:bg-cineplanet-blue/20'; ?>">
        ...
        <a href="reportes_tester.php" class="mt-2 flex items-center rounded-lg px-4 py-2 <?php echo (isset($activePage) && $activePage === 'reportes') ? 'bg-cineplanet-blue/30 text-white' : 'text-gray-300 hover:bg-cineplanet-blue/20'; ?>">
