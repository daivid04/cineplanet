    ...
    <div class="w-full max-w-2xl bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-8">
            <?php if ($error): ?>
                ...
                <div class="mt-4">
                    <a href="../dashboard.php" class="text-cineplanet-blue hover:underline">Volver al dashboard</a>
                </div>
            <?php elseif ($empleado): ?>
                ...
                <div class="mt-8 flex justify-end">
                    <a href="../dashboard.php" class="rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cineplanet-blue focus:ring-offset-2">Volver</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
