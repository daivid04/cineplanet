<aside class="flex h-full w-64 flex-col bg-slate-900 text-white shadow-xl transition-all duration-300 z-20">
    ...
    <nav class="flex-1 px-3 py-6 space-y-1">
        <a href="dashboard.php" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition-colors <?php echo (isset($activePage) && $activePage === 'dashboard') ? 'bg-cineplanet-blue text-white shadow-lg shadow-blue-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'; ?>">
        ...
        <a href="empleados.php" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition-colors <?php echo (isset($activePage) && $activePage === 'empleados') ? 'bg-cineplanet-blue text-white shadow-lg shadow-blue-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'; ?>">
        ...
        <a href="horarios.php" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition-colors <?php echo (isset($activePage) && $activePage === 'horarios') ? 'bg-cineplanet-blue text-white shadow-lg shadow-blue-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'; ?>">
        ...
        <a href="reportes.php" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition-colors <?php echo (isset($activePage) && $activePage === 'reportes') ? 'bg-cineplanet-blue text-white shadow-lg shadow-blue-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'; ?>">
    ...
    <div class="p-4 border-t border-slate-800 bg-slate-900/50">
        <a href="configuracion.php" class="group flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors <?php echo (isset($activePage) && $activePage === 'configuracion') ? 'bg-cineplanet-blue text-white shadow-lg shadow-blue-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'; ?>">
