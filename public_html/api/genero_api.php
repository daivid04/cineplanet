<?php
/**
 * API REST para Género
 * 
 * Endpoints:
 * GET    /api/genero_api.php          - Listar todos los géneros
 * GET    /api/genero_api.php?id=1     - Obtener género por ID
 * GET    /api/genero_api.php?activos=1 - Solo géneros activos
 * POST   /api/genero_api.php          - Crear nuevo género
 * PUT    /api/genero_api.php          - Actualizar género
 * PATCH  /api/genero_api.php          - Cambiar estado (toggle)
 * DELETE /api/genero_api.php?id=1     - Eliminar género (soft delete)
 */
...
require_once __DIR__ . '/../../src/controllers/GeneroController.php';

$controller = new GeneroController($conn);
    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            if (!$data || !isset($data['nombre']) || trim($data['nombre']) === '') {
                $response = ['success' => false, 'message' => 'El nombre del género es requerido'];
            } else {
