...
if (!$id) {
    header("Location: ../empleados_tester.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result['success']) {
        $message = "Empleado actualizado exitosamente. <a href='../empleados_tester.php' class='underline'>Volver a la lista</a>";
        // Recargar datos
        $empleadoResult = $controller->getById($id);
        if ($empleadoResult['success']) {
            $empleado = $empleadoResult['data'];
...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <div class="w-full max-w-2xl bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="bg-cineplanet-dark text-white p-6 flex justify-between items-center">
            ...
            <a href="../empleados_tester.php" class="text-gray-300 hover:text-white">
        ...
        <div class="p-8">
            ...
            <form action="" method="POST" class="space-y-6">
                ...
                <div class="flex justify-end pt-4">
                    <a href="../empleados_tester.php" class="mr-4 rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cineplanet-blue focus:ring-offset-2">Cancelar</a>
