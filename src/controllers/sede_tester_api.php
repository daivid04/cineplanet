<?php
/**
 * API Genérica para probar el controlador de Sede
 * 
...
try {
    // Obtener el controlador a usar (por defecto sede)
    $tabla = isset($_GET['tabla']) ? $_GET['tabla'] : 'sede';
    ...
    $controllerFile = __DIR__ . "/" . $tabla . "_controller.php";
